...
import { Dentist } from "../../dentist/base/Dentist";
...
export class AppointmentResolverBase {
  ...
  async createAppointment(
    ...
    return await this.service.createAppointment({
      ...
      data: {
        ...
        dentist: args.data.dentist
          ? {
              connect: args.data.dentist,
            }
          : undefined,
      },
    });
  ...
  async getDentist(
    ...
    const result = await this.service.getDentist(parent.id);
