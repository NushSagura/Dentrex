...
@InputType()
class InvoiceCreateNestedManyWithoutAppointmentsInput {
...
export { InvoiceCreateNestedManyWithoutAppointmentsInput as InvoiceCreateNestedManyWithoutAppointmentsInput };
