...
@InputType()
class AppointmentCreateNestedManyWithoutDentistsInput {
...
export { AppointmentCreateNestedManyWithoutDentistsInput as AppointmentCreateNestedManyWithoutDentistsInput };
